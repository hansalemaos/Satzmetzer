...
class Satzmetzger:
    def __init__(self):
        ...
        self.vorherchecken = self.read_pkl("TOKEN_VORHER.PKL")
        self.domains = self.read_pkl("TOKEN_DOMAINSFINDEN.PKL")
        self.abkuerzungen = self.read_pkl("TOKEN_REGEXABKUERZUNGEN.PKL")
        self.dateiendungen = self.read_pkl('TOKEN_DATEIENDUNGEN_IGNORECASE.PKL')
